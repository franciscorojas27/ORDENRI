        ...
        <a href="<?php echo e(route('dashboard')); ?>">
            <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                    <?php echo e(__('Numero de :attribute', ['attribute' => __($key)])); ?></h3>
                <p class="text-3xl font-bold mt-2"><?php echo e($count); ?></p>
            </div>    
        </a>
        <?php switch($key):
            case ('Evaluación'): ?>
...
<?php /**PATH C:\Users\franc\Desktop\ORDENRI\resources\views/components/charts/metrics-values.blade.php ENDPATH**/ ?>