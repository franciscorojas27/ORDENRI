                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input required readonly id="client_id" class="block mt-2 w-full" type="text"
                                name="client_id" :value="old('client', $order['client']['name'] ?? ($order['client_name'] ?? ''))" />
                            <x-input-error :messages="$errors->get('applicant')" class="mt-2" />
                        </div>
    
                        <div>
                            <x-input-label for="id" class="mt-2" :value="__('N°')" />
                            <x-text-input required readonly id="id" class="block mt-2 w-full" type="text" name="id"
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input required readonly id="created_at" class="block mt-2 w-full" type="text" name="created_at"
                        ...
                        <div>
                            ...
                            <x-text-input required readonly id="start_at" class="block mt-2 w-full" type="text" name="start_at"
                                :value="old('start_at', $order['start_at'] ? $order['start_at'] : 'No iniciado')"   />
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input required readonly id="end_at" class="block mt-2 w-full" type="text" name="end_at"
                                :value="old('end_at', $order['end_at'] ? $order['end_at'] : 'No finalizado')"   />
                    ...
                    <div>
                        ...
                        <x-textarea required readonly id="client_description" name="client_description" rows="4" cols="65"
