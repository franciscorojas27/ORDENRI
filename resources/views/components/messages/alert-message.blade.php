<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
    ...
    <span class="block sm:inline">No tienes permiso para realizar esta accion.</span>
    <script>
        setTimeout(function() {
            document.querySelector(".bg-red-100").remove();
        }, 10000);
    </script>
    <button type="button" class="absolute top-0 bottom-0 right-0 px-4 py-3 focus:outline-none" onclick="this.parentNode.remove();">
