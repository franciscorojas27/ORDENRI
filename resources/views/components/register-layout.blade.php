...
<div class="flex space-x-4">
    <div class="w-1/2">
        <x-input-label for="name" :value="__('Name')" class="text-white mt-2" />
        <x-text-input id="name"
            class="block mt-1 w-full bg-gray-700 text-white border-gray-600 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
            type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        <x-input-error :messages="$errors->get('name')" class="mt-2 text-red-400" />
    </div>
    <div class="w-1/2">
        <x-input-label for="last_name" :value="__('Last name')" class="text-white mt-2" />
...
@if (request()->routeIs('admin-secure.create'))
    <!-- Job title -->
    <div>
        <x-input-label for="job_title" :value="__('Job title')" class="text-white mt-2" />
        <select id="job_title" name="job_title"
            class="block w-full mt-1 bg-gray-700 text-white border-gray-600 focus:border-indigo-500 focus:ring rounded-md focus:ring-indigo-200 focus:ring-opacity-50"
            required>
        ...
        <x-input-error :messages="$errors->get('job_titles')" class="mt-2 text-red-400" />
    </div>
@endif

<!-- Resolution area -->
<div>
    <x-input-label for="resolution_area" :value="__('Resolution area')" class="text-white mt-2" />
    ...
    <x-input-error :messages="$errors->get('resolution_areas')" class="mt-2 text-red-400" />
</div>

<!-- Coordination/Management -->
<div>
    <x-input-label for="coordination_management" :value="__('Coordination/Management')" class="text-white mt-2" />
...
<!-- General Management -->
<div>
    <x-input-label for="general_management" :value="__('General management')" class="text-white mt-2" />
    <select id="general_management" name="general_management"
        class="block rounded-md w-full mt-1 bg-gray-700 text-white border-gray-600 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        required>
...
<!-- Email Address -->
<div>
    <x-input-label for="email" :value="__('Email')" class="text-white mt-2" />
...
<!-- Phone -->
<div>
    <x-input-label for="phone" :value="__('Phone')" class="text-white mt-2" />
...
<!-- Password -->
<div>
    <x-input-label for="password" :value="__('Password')" class="text-white mt-2" />
...
<!-- Confirm Password -->
<div>
    <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="text-white mt-2" />
